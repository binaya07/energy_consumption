...
class ResConv2d(nn.Module):
    """ Three Conv2d layers with a skip connection """
...
class ResidualVisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained='', pretrained_layers=[], verbose=True):
        if os.path.isfile(pretrained):
            ...
            # print("\n"*20)
            # print("pretrained_dict[\"head.weight\"].shape")
            # print(pretrained_dict["head.weight"].shape)
            ...
            # print("\n"*2)
            # print("need_init_state_dict[\"head.weight\"].shape")
            # print(need_init_state_dict["head.weight"].shape)
            # print("\n"*2)
...
#             config.VERBOSE
#         )
#     msvit.stage0.requires_grad = False
#     msvit.stage1.requires_grad = False
#     # msvit.stage2.requires_grad = False
